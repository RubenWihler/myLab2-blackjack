...
C_SRCS += \
../src/liblcp/spi/spi.c 

C_DEPS += \
./src/liblcp/spi/spi.d 

OBJS += \
./src/liblcp/spi/spi.o 


# Each subdirectory must supply rules for building sources it contributes
src/liblcp/spi/%.o: ../src/liblcp/spi/%.c src/liblcp/spi/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-liblcp-2f-spi

clean-src-2f-liblcp-2f-spi:
	-$(RM) ./src/liblcp/spi/spi.d ./src/liblcp/spi/spi.o

.PHONY: clean-src-2f-liblcp-2f-spi
